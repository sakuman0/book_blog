$(function () {
    ...
    $.ajax({
        ...
        function (data) {
            let target = $(".award-detail").attr("class").replace("award-detail", "").trim();
            ...
            for (let i = 0; i <= show_book; i++) {
                let add_place = ".award-detail .item-" + i;
                ...
                let img = $(".award-detail .item-" + i + " img").attr("src");
                ...
                $.ajax({
                    ...
                    function (data) {
                        ...
                        for (let i = min; i <= max; i++) {
                            ...
                            let add_place = ".award-detail .item-" + current_page_num;
